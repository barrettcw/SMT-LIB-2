...
\newcommand{\rem}[2]{{\color{red} \textsf{[#1: #2]}}}
\newcommand{\todo}[1]{\rem{To do}{#1}}
\newcommand{\cbrem}[1]{\rem{CB}{#1}}
\newcommand{\asrem}[1]{\rem{AS}{#1}}
\newcommand{\ctrem}[1]{\rem{CT}{#1}}
\newcommand{\pfrem}[1]{\rem{PF}{#1}}
...
\newcommand{\sorttt}[2]{\mathit{Sort}_{#1}(#2)}
...
\newcommand\vartextvisiblespace[1][1em]{%
  \makebox[#1]{%
    \kern.07em 
    \vrule height.3ex
    \hrulefill
