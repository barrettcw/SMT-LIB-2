...
\begin{enumerate}
\item support for a form of prenex polymorphism in user-defined sorts and functions, and
\item an extension to higher-order logic syntax obtained with the introduction of a theory of \emph{maps}.
\end{enumerate}

Aside from new functionality, which required introducing
a new command and assigning special meaning 
...
Andrew Reynolds for proposing a transitional version to SMT-LIB 3.
Special thanks go to 
Nikolaj Bj{\o}rner and
Andrew Reynolds for their feedback and useful suggestions.
We also thank 
Haniel Barbosa,
Guillaume Bury, and 
Levent Erkök
for their feedback on the reference document and the standard, and 
