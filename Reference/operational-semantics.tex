...
TODO CHECK THIS WITH CESARE

\new{If any subterm of $t$ has a polymorphic sort $\tau$ over sort parameters
$u_1$,\ldots, $u_n$, then the sort parameters are implicitly
...
Note that because of the syntactic restriction to rank-1 polymorphis
...
the effect of stating that there is a sort whose domain that cardinality 
